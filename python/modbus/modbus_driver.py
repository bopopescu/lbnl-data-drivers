...
class Modbus_Driver(object):
    ...
    def write_single_register(self,register,value):
        """
        register -- address of reigster to write
    ...
    def read_coil(self,register):
        """
        register -- coil register address to read
    ...
    def read_register_raw(self,register,length):
        """
        register -- base holding register address to read
        length -- amount of registers to read to encompass all of the data necessary
            for the type
    ...
    def read_input_raw(self,register,length):
        """
        register -- base input register address to read
        length -- amount of registers to read to encompass all of the data necessary
            for the type
        returns -- A deferred response handle
        """
    ...
    def decode_register(self,register,type):
        """
        register --- holding register address to retrieve
        type  --- type to interpret the registers retrieved as
        returns -- Nothing
    ...
    def decode_input_register(self,register,type):
        """
        register --- input register address to retrieve
        type  --- type to interpret the registers retrieved as
        returns -- Nothing
    ...
    def get_data(self):
        ...
        that contained in the YAML config file, register names cannot be repeated
